...
class CustomerPageTextServiceTest {
    ...
    @Test
    void switchPriorities_shouldReturnEmptyList_ifCustomerPageTextsAreNotNextToEachOtherInPriority(){
        CustomerPageText customerPageTextToIncrement = CustomerPageText.builder()
                .page(TEST_PAGE)
                .priority(1)
                .build();
        CustomerPageText customerPageTextToReplace = CustomerPageText.builder()
                ...
                .priority(5)
                .build();
        assertTrue(customerPageTextService.switchPriorities(
                true, customerPageTextToIncrement, customerPageTextToReplace).isEmpty());
    }

    @Test
    void switchPriorities_shouldReturnEmptyList_ifCustomerPageTextsAreNotFromTheSamePage(){
        CustomerPageText customerPageTextToIncrement = CustomerPageText.builder()
                .page(TEST_PAGE)
                .priority(1)
                .build();
