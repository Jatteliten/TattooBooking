...
class BookableDateServiceTest {
    ...
    void createBookableDatesFromDateForm_shouldReturnCorrectBookableDates_andBookableHours(){
        ...
        assertEquals(TODAY, bookableDates.get(0).getDate());
        assertEquals(TODAY.plusDays(1), bookableDates.get(1).getDate());
        assertEquals(TEN_O_CLOCK, bookableDates.get(0).getBookableHours().get(0).getHour());
        assertEquals(TWELVE_O_CLOCK, bookableDates.get(1).getBookableHours().get(0).getHour());
    }
